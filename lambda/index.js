...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        const speakOutput = 'Welcome to Lifted Life Alexa Stream .Playing the audio stream.';
        const playBehavior = 'REPLACE_ALL';
        const podcastUrl = 'https://s2.radio.co/s541cd30f8/listen';
        ...
        return handlerInput.responseBuilder
            ...
            .addAudioPlayerPlayDirective(
                ...
                playbackInfo.offsetInMilliseconds
                   ...
                   .withStandardCard(
                "Welcome to Lifted Life Alexa Stream",
                "Where your journey through the most soul-stirring inspirational and spiritual melodies begins. Immerse yourself in a curated selection of songs that promise to elevate your spirit and bring serenity right into your sanctuary."
            )
            .getResponse();
    }
};
